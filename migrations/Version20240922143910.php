 ...
 */
final class Version20240922143910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE poll CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE post CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE topic CHANGE created_at created_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE poll CHANGE created_at created_at DATETIME NOT NULL');
